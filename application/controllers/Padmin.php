...
class Padmin extends CI_Controller{
	...
	public function tes_excel(){
		...
		->setCellValue('E3', 'Target %')
		->setCellValue('F3', 'Real %')
		->setCellValue('G3', 'Deviasi %')
		->setCellValue('H3', '(Rp.)')
		->setCellValue('I3', '( % )')
		->setCellValue('B4', '2')
		->setCellValue('C4', '3')
		...
		->setCellValue('E4', '5')
		->setCellValue('F4', '6')
		->setCellValue('G4', '7 = 6 - 5')
		->setCellValue('H4', '8')
		->setCellValue('I4', '9 = 8:3')
		->setCellValue('J4', '10 = 3 - 8');
		...
		$objPHPExcel->getActiveSheet()->setCellValue('C1','Total Dana Dalam DPA');
		$objPHPExcel->getActiveSheet()->setCellValue('D1','PPTK');
		$objPHPExcel->getActiveSheet()->setCellValue('E1','Perkembangan Pelaksanaan');
		$objPHPExcel->getActiveSheet()->setCellValue('E2','Sisa Anggaran (Rp.)');
		$objPHPExcel->getActiveSheet()->setCellValue('H2','Realisasi Fisik');
		$objPHPExcel->getActiveSheet()->setCellValue('J1','Daya Serap Keuangan');
		$objPHPExcel->getActiveSheet()->getStyle("A1:J4")->applyFromArray($style);
		$objPHPExcel->getActiveSheet()->getStyle("A1:J4")->applyFromArray($border_style);
		...
		foreach($cc->result_array() as $i)
		{
			...
			$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(2, $excel_row, ($csumpag['sumpagu']+$sumanggaran['angpagu']));
			$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(3, $excel_row, $i['user_nama']);
			$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4, $excel_row,  '0');
			$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(5, $excel_row,  '0');
			$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(6, $excel_row,  '0');
			$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(7, $excel_row, ($xsum));
			$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(8, $excel_row,  '0');
			$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(9, $excel_row, ($csumpag['sumpagu']-($xsum)));
			$excel_row++;
//		set_time_limit(20);
			$objPHPExcel->getActiveSheet()->getStyle("A".($excel_row-1).":j".($excel_row-1))->applyFromArray($border_style, False);
...
*/
		...
		$objPHPExcel->getActiveSheet()->setTitle('DataExcel');
